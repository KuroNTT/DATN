...
@Component({
  ...
  <div class="overflow-x-auto">
    ...
    <th class="px-2 py-2 border w-[100px] text-center">Thao tác</th>
      ...
      <tbody>
        <tr *ngFor="let blog of blogs | paginate: {itemsPerPage: 5, currentPage: p}" class="hover:bg-gray-50 text-center">
          ...
          <td class="px-4 py-2 border">{{ getCategoryName(blog.category_id) }}</td>
  ...
  <div class="flex justify-center items-center mt-6 space-x-2">
    ...
    <ng-container *ngFor="let page of pg.pages">
      <button
        ...
        [ngClass]="{
          'bg-black text-white shadow-md': pg.getCurrent() === page.value,
          'bg-white text-black border-[#c5c5c5] hover:bg-[#f3f3f3]': pg.getCurrent() !== page.value
        }"
